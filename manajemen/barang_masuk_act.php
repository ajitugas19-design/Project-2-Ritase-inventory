...
(bm_id_barang, bm_nama_barang, bm_tgl_masuk, bm_jumlah, bm_id_suplier, bm_lokasi_asal, bm_lokasi_tujuan, bm_keterangan)
VALUES 
('$barang','$nama_barang','$tanggal','$jumlah','$suplier','$nama_suplier','$lokasi_tujuan','$keterangan') ");
