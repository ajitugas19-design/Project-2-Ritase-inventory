                ...
                <tfoot>
                  <tr class="bg-info">
                    ...
                    <th>
                      <?php 
                      include '../koneksi.php';
                      $total = mysqli_query($koneksi, "SELECT SUM(bm_jumlah) as total_jumlah FROM barang_masuk");
...
// Function to search barcode for barang masuk
function cariBarcodeMasuk() {
    ...
    // Search for barang based on barcode (barang_keterangan) or barang_id
